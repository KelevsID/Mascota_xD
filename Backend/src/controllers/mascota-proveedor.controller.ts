...
export class MascotaProveedorController {
  ...
  @get('/mascotas/{id}/proveedors', {
    responses: {
      '200': {
        description: 'Array of Mascota has many Proveedor through ConsultaVeterinaria',
        content: {
          'application/json': {
  ...
  async find(
    ...
    return this.mascotaRepository.proveedors(id).find(filter);
  }
  ...
  async create(
    ...
    return this.mascotaRepository.proveedors(id).create(proveedor);
  }
  ...
  async patch(
    ...
    return this.mascotaRepository.proveedors(id).patch(proveedor, where);
  }
  ...
  async delete(
    ...
    return this.mascotaRepository.proveedors(id).delete(where);
  }
}
